...
sra = pd.read_csv("/data/home/visitor/maize/maize/DNA_seq/snakemake/CRR.txt",sep="\t")
...
rule get_CRR_files:
    ...
    run:
        shell("wget -O {output.fw} ftp://download.big.ac.cn/gsa/CRA007020/{params.CRR}/{params.CRR}_f1.fq.gz")
        shell("wget -O {output.rev} ftp://download.big.ac.cn/gsa/CRA007020/{params.CRR}/{params.CRR}_r2.fq.gz")
